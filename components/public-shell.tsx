...
> = {
  ...
  ru: {
    ...
    steps: [
      'Начните с 400 проверенных слов и ищите на русском, английском, грузинском или латиницей.',
      'Используйте расширенный словарь на 9 000 слов как справочный бета-материал.',
      'Настройте цель и темп для персональных уроков по три слова.',
    ],
  },
  ka: {
    ...
    steps: [
      'დაიწყეთ 400 შემოწმებული სიტყვით და მოძებნეთ ქართულად, ინგლისურად, რუსულად ან ლათინური ასოებით.',
      'გამოიყენეთ 9 000-სიტყვიანი გაფართოებული ლექსიკონი საცნობარო ბეტა მასალად.',
      'აირჩიეთ მიზანი და ტემპი პერსონალური სამსიტყვიანი გაკვეთილებისთვის.',
    ],
  },
};
