...
export function PublicFooter() {
  return <footer className="public-footer"><div className="footer-brand"><a className="brand" href="/">GEO<span>.</span></a><p>Practical Georgian for everyday life.</p><small>Public beta · Updated September 2026</small></div><div><b>Product</b><a href="/features">Features</a><a href="/phrasebook">Phrasebook</a><a href="/guided-learning">Guided Learning</a><a href="/pricing">Pricing</a><a href="/install">How to use GEO</a></div><div><b>Company</b><a href="/about">About</a><a href="/help">Help Center</a><a href="/changelog">Changelog</a><a href="/security">Security</a></div><div><b>Legal</b><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/cookies">Cookies</a><a href="/acceptable-use">Acceptable use</a><a href="/data-deletion">Data deletion</a><a href="/refunds">Refunds</a><a href="/accessibility">Accessibility</a></div></footer>;
}

export function InfoPage({ eyebrow, title, intro, children }: { eyebrow: string; title: string; intro: string; children: React.ReactNode }) {
  return <main className="legal-page"><PublicHeader /><article><a className="back-home" href="/"><ArrowLeft /> Back to GEO</a><span className="legal-eyebrow">{eyebrow}</span><h1>{title}</h1><p className="legal-intro">{intro}</p>{children}</article><PublicFooter /></main>;
}
