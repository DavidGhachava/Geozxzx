...
> = {
  ...
  ru: {
    ...
    steps: [
      'Начните с 50 бесплатных практических фраз для повседневной жизни.',
      'Phrasebook Pro открывает справочный словарь на 9 000 слов.',
      'Guided Learning добавляет персональные уроки по три слова.',
    ],
  },
  ka: {
    ...
    steps: [
      'დაიწყეთ ყოველდღიური ცხოვრების 50 უფასო პრაქტიკული ფრაზით.',
      'Phrasebook Pro ხსნის 9 000-სიტყვიან საცნობარო ლექსიკონს.',
      'Guided Learning ამატებს პერსონალურ სამსიტყვიან გაკვეთილებს.',
    ],
  },
};
